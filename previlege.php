...
<div class="uk-position-relative previlege">
    ...
    <div class="uk-section-small uk-light" uk-toggle="cls: uk-position-cover; mode: media; media: @m">
        <div class="uk-container">
            <div uk-grid>
                <div class="uk-width-2-5@m">
                    <div class="uk-child-width-auto uk-grid-small uk-flex-middle" uk-grid>
                        <div>
                            <img class="previlege__img" src="images/Group1.png" alt="">
                        </div>
                        <div>
                            <div class="previlege__title">
                                <div>Levista</div>
                                Privileges
                            </div>
                        </div>
