...
<div class="uk-position-relative uk-overflow-hidden uk-background-top-center tuyendung__box2 uk-background-cover" data-src="images/bg1.png" uk-img>
    ...
    <div class="uk-position-relative">
        ...
        <div class="uk-section-small duan__content">
            ...
            <!--Nha dau tu-->
            <div class="duan__item uk-position-relative" id="">
                <div class="uk-container">
                    <div class="uk-margin">
                        <img class="tuyendung__content__img" src="images/tuyendung/Vector.png" alt="">
                        <h1 class="uk-h1 tuyendung__content__title uk-margin-remove">Nhà Đầu Tư Và Phát <br> Triển Dự Án</h1>
                    </div>
                    <div class="duan__nhadautu__box1">
                        <div class="uk-child-width-1-2 uk-child-width-1-4@m uk-grid-match" uk-grid>
                            <div>
                                <div class="uk-grid-match uk-flex-column uk-grid-small" uk-grid>
                                    <div class="uk-width-1-1 uk-flex-auto duan__nhadautu__box1__flexauto">
                                        <div class="uk-flex uk-flex-middle uk-height-1-1">
                                            <img class="uk-responsive-height" src="images/duan6/image83.png" alt="">
                                        </div>
                                    </div>
                                    <div class="uk-width-1-1">
                                        <h3 class="uk-h3 duan__nhadautu__box1__title">Chủ đầu tư dự án</h3>
                                        <p class="duan__nhadautu__box1__desc"><span>Indochina Hội An Beach Villas:</span> trực thuộc Tập Đoàn Bamboo Capital, một trong 500 doanh nghiệp lớn nhất Việt Nam.</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="uk-grid-match uk-flex-column uk-grid-small" uk-grid>
                                    <div class="uk-width-1-1 uk-flex-auto duan__nhadautu__box1__flexauto">
                                        <div class="uk-flex uk-flex-middle uk-height-1-1">
                                            <img class="uk-responsive-height" src="images/duan6/image92.png" alt="">
                                        </div>
                                    </div>
                                    <div class="uk-width-1-1">
                                        <h3 class="uk-h3 duan__nhadautu__box1__title">Đơn Vị Phát Triển Dự Án</h3>
                                        <p class="duan__nhadautu__box1__desc"><span>Bamboo Capital Group (BCG):</span> Được thành lập vào năm 2011, Bamboo Capital Group (BCG) đã nhanh chóng phát triển thành một trong những công ty đa ngành hàng đầu tại Việt Nam.</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="uk-grid-match uk-flex-column uk-grid-small" uk-grid>
                                    <div class="uk-width-1-1 uk-flex-auto duan__nhadautu__box1__flexauto">
                                        <div class="uk-flex uk-flex-middle uk-height-1-1">
                                            <img class="uk-responsive-height" src="images/duan6/image89.png" alt="">
                                        </div>
                                    </div>
                                    <div class="uk-width-1-1">
                                        <h3 class="uk-h3 duan__nhadautu__box1__title">Đơn Vị Thi Công</h3>
                                        <p class="duan__nhadautu__box1__desc"><span>Ricons:</span> trực thuộc Coteccons Group danh tiếng, Ricons là Top 3 nhà thầu lớn nhất Việt Nam, lấy uy tín chất lượng làm thước đo giá trị thương hiệu</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="uk-grid-match uk-flex-column uk-grid-small" uk-grid>
                                    <div class="uk-width-1-1 uk-flex-auto duan__nhadautu__box1__flexauto">
                                        <div class="uk-flex uk-flex-middle uk-height-1-1">
                                            <img class="uk-responsive-height" src="images/duan6/image891.png" alt="">
                                        </div>
                                    </div>
                                    <div class="uk-width-1-1">
                                        <h3 class="uk-h3 duan__nhadautu__box1__title">Đơn Vị THIẾT KẾ</h3>
                                        <p class="duan__nhadautu__box1__desc"><span>BAKH Architecture (USA):</span>  Dự án được xây dựng dựa trên thiết kế ý tưởng của BAKH Architecture, một đơn vị thiết kế kiến trúc quốc tế danh tiếng, nhận nhiều giải thưởng danh giá, uy tín trên thế giới</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="duan__item uk-position-relative" id="chinhsachbanhang">
                <div class="uk-container">
                    ...
                    <div class="uk-child-width-1-1 uk-margin-medium uk-grid-large" uk-grid>
                        <div>
                            <div uk-grid>
                                <div class="uk-width-1-3@m">
                                    <div>
                                        <img class="tuyendung__content__img" src="images/tuyendung/Vector.png" alt="">
                                        <h1 class="uk-h1 tuyendung__content__title uk-margin-remove">GIÁ BÁN DỰ KIẾN</h1>
                                    </div>
                                </div>
                                <div class="uk-width-expand">
                                    <div class="uk-child-width-1-2@m" uk-grid>
                                        <div>
                                            <div class="uk-margin">
                                                <div class="uk-flex duan__nhadautu__box2__img uk-border-circle uk-flex-center uk-flex-middle uk-flex-inline">
                                                    <img class="uk-responsive-height uk-responsive-width" src="images/duan6/Vector1.png" alt="">
                                                </div>
                                            </div>
                                            <div class="duan__nhadautu__box2__txt1">Căn hộ nghỉ dưỡng:</div>
                                            <div class="duan__nhadautu__box2__txt2"><span>46</span> triệu đồng/m2</div>
                                            <div class="duan__nhadautu__box2__txt3">* Bàn giao Full nội thất tiêu chuẩn 5*</div>
                                        </div>
                                        <div>
                                            <div class="uk-margin">
                                                <div class="uk-flex duan__nhadautu__box2__img uk-border-circle uk-flex-center uk-flex-middle uk-flex-inline">
                                                    <img class="uk-responsive-height uk-responsive-width" src="images/duan6/Group223.png" alt="">
                                                </div>
                                            </div>
                                            <div class="duan__nhadautu__box2__txt1">Biệt thự nghỉ dưỡng:</div>
                                            <div class="duan__nhadautu__box2__txt2"><span>12-18</span> tỷ</div>
                                            <div class="duan__nhadautu__box2__txt3">* Bàn giao Full nội thất tiêu chuẩn 5*</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div uk-grid>
                                <div class="uk-width-1-3@m">
                                    <div>
                                        <img class="tuyendung__content__img" src="images/tuyendung/Vector.png" alt="">
                                        <h1 class="uk-h1 tuyendung__content__title uk-margin-remove">PHƯƠNG THỨC <br> THANH TOÁN</h1>
                                    </div>
                                </div>
                                <div class="uk-width-expand">
                                    <div class="uk-child-width-1-2@m" uk-grid>
                                        <div>
                                            <div class="duan__nhadautu__box2__txt4">Đặt mua lần 1:</div>
                                            <div class="duan__nhadautu__box2__txt2"><span>200</span> triệu đồng</div>
                                        </div>
                                        <div>
                                            <div class="duan__nhadautu__box2__txt4">Đặt mua lần 2:</div>
                                            <div class="duan__nhadautu__box2__txt2"><i>Đóng đủ</i> <span>15%</span> <i>trong vòng</i>
                                                <br> 15 ngày <i>kể từ ngày kí TTĐM</i></div>
                                        </div>
                                        <div class="uk-width-1-1">
                                            <ul class="uk-list uk-list-bullet duan__nhadautu__box2__list">
                                                <li><span>Đợt 1:</span> 30% sau khi hoàn thành móng cọc (ký hợp đồng mua bán - HĐMB)</li>
                                                <li><span>Đợt 2:</span> 10% sau 3 tháng kể từ khi ký HĐMB</li>
                                                <li><span>Đợt 3:</span> 10% sau 6 tháng kể từ khi ký HĐMB</li>
                                                <li><span>Đợt 4:</span> 10% sau 9 tháng kể từ khi ký HĐMB</li>
                                                <li><span>Đợt 5:</span> 10% sau 12 tháng kể từ khi ký HĐMB</li>
                                                <li><span>Đợt 6:</span> 25% sau khi thông báo bàn giao căn hộ dự kiến</li>
                                                <li><span>Đợt 7:</span> 5% sau khi nhận thông báo cấp giấy chứng nhận quyền sở hữu</li>
                                            </ul>
                                        </div>
                                        <div class="uk-width-1-1">
                                            <p class="duan__nhadautu__box2__desc"><span class="duan__nhadautu__box2__desc__c1">**Đặc biệt**</span> Khách hàng có nhu cầu thanh toán trước hạn với tỉ lệ thanh toán <span class="duan__nhadautu__box2__desc__c2">95%</span> sẽ được hưởng mức chiết khấu tương đương <span class="duan__nhadautu__box2__desc__c2">6%</span>/<b>năm</b> trên khoản tiền và số ngày thanh toán trước hạn.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
